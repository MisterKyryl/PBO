(() => {
    ...
    function initSliders() {
        if (document.querySelector(".thumbs-product")) {
            const thumbsSwiper = new swiper_core_Swiper(".thumbs-product", {
            ...
            new swiper_core_Swiper(".image-product__slider", {
                modules: [ Thumb, Mousewheel, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 30,
    ...
    function updateGotoTop() {
        ...
        const menuItems = document.querySelectorAll('[data-goto="#how-it-works"]');
        if (window.innerWidth > 1400) menuItems.forEach((item => {
            item.setAttribute("data-goto-top", "0");
        })); else menuItems.forEach((item => {
            item.setAttribute("data-goto-top", "150px");
        }));
    }
    window.addEventListener("load", updateGotoTop);
